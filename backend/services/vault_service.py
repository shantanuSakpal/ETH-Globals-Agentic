...
class VaultService:
    ...
    async def create_vault(self, data: Dict[str, Any], user_id: str) -> Optional[Vault]:
        ...
        try:
            ...
            vault = Vault(
                ...
                current_balance=data.get("initial_deposit", 0),
    ...
    async def handle_deposit(self, user_id: str, vault_id: str, amount: float, token: str, slippage: float = 0.01) -> Dict[str, Any]:
